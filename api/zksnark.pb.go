...
import (
	core "github.com/gofika/fikatron/core"
...
func file_api_zksnark_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_zksnark_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_zksnark_proto_msgTypes[1].Exporter = func(v any, i int) any {
